...
<body class="bg-gray-100 text-black-900 text-center">
    ...
    <div class="flex-1 p-8 overflow-y-auto ai-style-change-1" role="main" tabindex="0" aria-label="Page d'accueil de l'association">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    <h3 class="text-2xl font-semibold text-black-800 mb-3">Bénévole ayant ramassé le plus de déchets </h3>
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    <h3 class="text-2xl font-semibold text-black-800 mb-3">Ville dans laquelle il y a eu le plus de déchets collectés </h3>
                    <p class="text-2xl font-bold text-blue-600 mt-5"><?=$ville_info_max['lieu']?></p>
                </div>
                <!-- Dernière collecte -->
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    <h3 class="text-2xl font-semibold text-black-800 mb-3">Type de déchet le plus ramassé </h3>
        ...
        <h3 class="mt-20 text-xl font-semibold text-black-800 mb-3"><i class="fa-regular fa-paper-plane mr-3"></i>Besoin d'aide ? Vous pouvez contacter</h3>
        <p class="text-lg text-black-800"><?=$adminNom?> en lui écrivant à  <?=$admin['email']?></p>
    </div>
</div>
</body>
</html>